...
import {CardHeader, Input, Button, Icon} from '../../components';
...
class GraphForm extends Component {
    constructor(props) {
        ...
        this.state = {
            id: window.graph_id ? window.graph_id : '',
            tableId: '',
            title: '',
            maxPoint: '12',
            lines,
    ...
    render() {
        const {tableId, tables, title, maxPoint, lines, tableError, titleError, maxPointError} = this.state;
        const _lines = lines.map((item, key) => {
            return <div key={key} className="form-group">
                <div className={'row'}>
                    ...
                    <div className={'col-7'}>
                        <Input value={item.filter} onChange={e => this.onLineChange(key, 'filter', e)} placeholder={'status = 200'} />
                    </div>
                    <div className={'col-1'}>
                    ...
                    <div className="card-body">
                        <form role="form">
                            <div className="form-group">
                                <label>Table</label>
                                <select value={tableId} className={tableError ? 'form-control is-invalid' : 'form-control'} onChange={this.onTableChange}>
